...
class Kernel
  ...
  setupDispatcher: (dispatcher) ->
    ...
    dispatcher.install @logic_create_custom, "create a custom named thing",                        "create",   "ALPHANUM", "ALPHANUM"
    dispatcher.install @logic_create_custom, "create a custom thing",                              "create",   "ALPHANUM"
